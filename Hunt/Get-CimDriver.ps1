...
.PARAMETER State
    Specifies one or more drivers by state.
...
#>
    ...
    PROCESS {
        Get-CimInstance Win32_SystemDriver -Filter $filter -CimSession $cimSession -Verbose:$false | ForEach-Object {
