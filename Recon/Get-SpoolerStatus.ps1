...
.DESCRIPTION
    Get-SpoolerStatus checks if Print Spooler service is running on a remote host.
    It is a slightly modified version of PingCastle's SpoolerScanner by @mysmartlogon.
